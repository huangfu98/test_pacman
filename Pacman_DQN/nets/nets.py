...
class DQNet(nn.Module):
	def __init__(self, config, **kwargs):
		...
		self.resnet18 = torchvision.models.resnet18() # resnet18 : 17个卷积层,一个全连接层输出
	...
	def train(self):
		...
		while True:
			...
			# train
				...
				if num_iter % self.config.save_interval == 0 or num_iter == self.config.max_train_iterations: # 存网络参数
